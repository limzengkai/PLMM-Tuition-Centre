          ...
          >
            ...
            <li className="items-center">
              <Link
                className={
                  "text-xs uppercase py-3 font-bold block " +
                  (window.location.href.indexOf("/admin/fee") !== -1
                    ? "text-lightBlue-500 hover:text-lightBlue-600"
                    : "text-blueGray-700 hover:text-blueGray-500")
                }
                to="/admin/fee"
            ...
            <li className="items-center">
              <Link
                className={
                  "text-xs uppercase py-3 font-bold block " +
                  (window.location.href.indexOf("/admin/attendance") !== -1
                    ? "text-lightBlue-500 hover:text-lightBlue-600"
                    : "text-blueGray-700 hover:text-blueGray-500")
                }
                to="/admin/attendance"
            ...
            <li className="items-center">
              <Link
                className={
                  ...
                  to="/admin/classes"
                >
                <i className={ "fas fa-book-open mr-2 text-sm " +
                  (window.location.href.indexOf("/admin/classes") !== -1
                  ? "opacity-75"
                  : "text-blueGray-300")
                  }
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/profile"
                >
                  <i className="fas fa-user-circle text-blueGray-400 mr-0 text-sm"></i>{" "}
                  Profile Page
                </Link>
              </li>
            </ul>
