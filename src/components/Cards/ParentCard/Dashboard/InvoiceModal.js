  ...
  function handleDownload() {
        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.flexContainer}>
              <View>
                <Text style={styles.label}>Payment Date: 
                  {
                    fees && 
                    fees.feeDetail &&
          ...
          <View style={styles.flexContainer}>
            <View style={[styles.section, styles.leftHalfContainer]}>
              ...
              <Text style={styles.label}>
                Address: No. 21, 21A, 23A & 25A, Jalan Pendekar 17, Taman Ungku
                Tun Aminah, 81300 Skudai, Johor
              </Text>
            ...
            <View style={[styles.section, styles.rightHalfContainer]}>
              ...
              <Text style={styles.label}>
                Address: {users.address}, {users.postcode} {users.city},{" "}
                {users.state}
              </Text>
          ...
          <View style={styles.flexContainer}>
            <View style={[styles.section, styles.TableFirstContainer]}>
              ...
              {fees &&
                fees.classes &&
                fees.classes.map((Classfee, index) => (
                  ...
                  <React.Fragment key={index}>
                    {Classfee.Quantity.map((quantity, idx) => (
                      <Text key={idx} style={styles.tablebody}>
                        RM{" "}
                        {parseFloat(quantity) *
                          parseFloat(Classfee.FeeAmounts[idx])}
                      </Text>
                    ))}
                  </React.Fragment>
                ))}
          ...
          <View style={styles.flexContainer}>
            ...
            <Text style={[styles.section, styles.TableThirdContainer]}>
              Total Fee:
            </Text>
            <Text style={[styles.section, styles.TableFourthContainer]}>
              RM{" "}
              {fees &&
                fees.classes &&
                fees.classes
          ...
          <View style={styles.flexContainer}>
            ...
            <Text style={[styles.section, styles.TableFourthContainer]}>
              RM {fees.feeDetail && fees.feeDetail.paidAmount.toFixed(2)}
            </Text>
          </View>
    ...
    pdf(doc)
      ...
      .then((blob) => {
        ...
        a.href = pdfUrl;
        a.download = "invoice_" + fees.feeDetail.DueDate.toDate().toDateString() +".pdf";
